...
This repossitory does **not** contain any admin scripts. These will eventually
be published in the future in another repository.  
  
This Repository will grow over time. I'll add more scripts as soll as they get
into my hands. I didn't collect all the scripts I wrote in a central point
until now.
